...
import { Calendar, Bell, ChevronLeft, Droplets } from "lucide-react"
        ...
        <div className="absolute top-4 left-4 z-50 pointer-events-auto flex flex-col gap-3 transition-all duration-300 ease-in-out" suppressHydrationWarning>
            ...
            >
                ...
                <Card className="w-80 bg-background/95 backdrop-blur-xl border border-amber-500/30 shadow-2xl transition-all hover:translate-x-1 hover:shadow-amber-500/20 duration-300 overflow-hidden group">
                    <div className="absolute inset-0 bg-gradient-to-r from-amber-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" suppressHydrationWarning />
                    <CardHeader className="p-4 pb-2 relative">
                        <CardTitle className="text-xs font-black flex items-center justify-between tracking-wider uppercase">
                            <div className="flex items-center gap-2" suppressHydrationWarning>
                                <div className="p-1.5 rounded-lg bg-amber-500/10" suppressHydrationWarning>
                ...
                <Card className="w-80 bg-background/95 backdrop-blur-xl border border-indigo-500/30 shadow-2xl transition-all hover:translate-x-1 hover:shadow-indigo-500/20 duration-300 overflow-hidden group">
                    <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" suppressHydrationWarning />
                    <CardHeader className="p-4 pb-2 relative">
                        <CardTitle className="text-xs font-black flex items-center justify-between tracking-wider uppercase">
                            <div className="flex items-center gap-2" suppressHydrationWarning>
                                <div className="p-1.5 rounded-lg bg-indigo-500/10" suppressHydrationWarning>
